...
public class P02 {
    public static void main(String[] args) throws InterruptedException {
        ...
        firstname.sendKeys("Sena",Keys.TAB,"Ok",Keys.TAB,Keys.ARROW_RIGHT,Keys.TAB,
                Keys.ARROW_RIGHT,Keys.ARROW_RIGHT,Keys.ARROW_RIGHT,Keys.TAB,"07/01/2024",Keys.TAB,Keys.TAB
